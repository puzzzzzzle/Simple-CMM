...
import zhangtao.iss2015.fourcode.FourCode;
import zhangtao.iss2015.fourcode.FourCodeItem;
            ...
            if (CodeText.textProperty().get() == null || CodeText.textProperty().get().equals("")) {
                ...
                try {
                    ...
                    if (semanticAnalysis.getErrorNum() != 0) {
                        ...
                        info.append("\noutput:\n");
                        info.append(PrecessOutput.textProperty().get());
                        info.append("\nstate:\n");
                        info.append(StateOutput.textProperty().get());
                        info.append("\n");
                        Logger.writeToLogs(info.toString(),String.valueOf(System.currentTimeMillis()));
                    }
                } catch (Exception e1) {
...
//            }
    ...
    private void generateCode() throws IOException {
        ...
        codes = FourCode.generateCode(text);
        ...
        info.append(StateOutput.textProperty().get());
        info.append("\n");
        Logger.writeToLogs(TreeText.textProperty().get(),String.valueOf(System.currentTimeMillis()));
    }
